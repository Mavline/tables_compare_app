...
- After all fixes, rerun the impacted verification commands from `AOC-VERIFY-001`. For UI-affecting fixes, that includes a real browser walkthrough; record the same kind of evidence the original builder was required to produce.
